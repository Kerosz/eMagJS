...
const Home = {
  getData: async () => {
    ...
    if (!response || response.statusText !== 'OK') {
      console.error(`Error in getting data: ${response.status}`);
      return '<div>Error in getting data</div>';
    }

    const query = response.data;
    try {
      if (query.products) return query.products;
    } catch (error) {
        ...
        return `
          <li class="store__products-item">
            <div class="product">
              ...
              <a href="/#/product/${id}" class="product__image">
              ...
              <div class="product__more">
                ...
                <button class="product__basket btn-emag">
